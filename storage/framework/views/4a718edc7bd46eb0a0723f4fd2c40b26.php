    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(route('brand.index')); ?>">Base</a>
            <a class="collapse-item" href="<?php echo e(route('brand.create')); ?>">Add Base</a>
          </div>
        </div>
    </li>
...
<?php /**PATH E:\work\study\Complete-Ecommerce-in-laravel-10\resources\views/backend/layouts/sidebar.blade.php ENDPATH**/ ?>