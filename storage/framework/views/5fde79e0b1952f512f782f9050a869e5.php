...
<?php $__env->startSection('main-content'); ?>
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="<?php echo e(route('brand.create')); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Base</a>
    </div>
    <div class="card-body">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\work\study\Complete-Ecommerce-in-laravel-10\resources\views/backend/brand/index.blade.php ENDPATH**/ ?>